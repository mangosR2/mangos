...
extern int main(int argc, char **argv)
{
    ...
    sLog.outString("BOOT: Please, visit to github branch or forum http://mangosr2.2x2forum.com for report bugs");
    sLog.outString("BOOT: Using configuration file %s.", cfg_file);
