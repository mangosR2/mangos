...
enum eConfigUInt32Values
{
    ...
    CONFIG_UINT32_CHAT_DISABLE_SAYLEVEL,
    CONFIG_UINT32_CHAT_DISABLE_YELLLEVEL,
    CONFIG_UINT32_CHAT_DISABLE_WHISPERLEVEL,
    CONFIG_UINT32_CHAT_DISABLE_PARTYLEVEL,
    CONFIG_UINT32_CHAT_DISABLE_GUILDLEVEL,
    CONFIG_UINT32_CHAT_DISABLE_RAIDLEVEL,
    CONFIG_UINT32_CHAT_DISABLE_BGLEVEL,
    CONFIG_UINT32_CHAT_DISABLE_CHANNELLEVEL,
